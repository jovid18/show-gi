...
- **판 표면은 three.js가 그린다**([06-status.md §35](06-status.md)). 다만 **원근이 아니다**: 정사영 카메라에 판과 픽셀이 맞는 평면이고, 그 위의 駒·광선·표식은 그대로 DOM이다. 「3D 보드」라고 쓰면 거짓말이 된다 — 3D 예산은 **利きの그늘** 한 겹에 다 들어갔다
