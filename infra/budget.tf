...
resource "aws_budgets_budget" "monthly" {
  ...
  #
  # 부하 시험은 이 선을 의도적으로 넘는다. 그때 오는 메일은 확인 신호다.
...
# SNS 로 보낸다. 예산은 주소를 직접 받을 수도 있는데, 그쪽은 확인 절차가
# 따로이고 확인 링크가 스팸함에 들어가면 경고 없이 아무것도 오지 않는다 — 2026-09-08 에 알람
