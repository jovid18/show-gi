...
**새 사실을 절 하나로 덧붙이고 끝내지 않는다.** 그 사실이 무효화한 옛 문장을 같은 PR에서 찾아 고친다 — 안 그러면 문서가 자기 자신과 모순하고, 그건 틀린 문서보다 나쁘다(읽는 사람이 어느 절을 먼저 읽었느냐로 결론이 갈리고 대조로도 안 잡힌다). 실제로 네 번 그렇게 갈렸다([§29](docs/06-status.md)).
