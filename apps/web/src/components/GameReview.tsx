...
import type { GameDetail, ReviewIntervention, ReviewMove } from '@/review/protocol';
...
import { branchMotion, evalText, stepMotion } from '@/whatif/branch';
import { httpSend } from '@/whatif/http';
