...
//
// [미확정] 판 10개다 — 15級 3판, 그리고 위 끝은 初段 1판 + 三段 3판의 평평한 구간이다.
// 판 하나의 흔들림이 20~40%라 앵커 자체가 ±15%다.
var rankAnchors = [...]rankAnchor{
	{Step: 0, Loss: 0.1265},       // 15級 — 판 3개
	{Step: RankMax, Loss: 0.0670}, // 初段 이상 — 初段 0.0683 · 三段 0.0651
}
