...
// 알 수 없다」고 적어둔 자리다). 기록된 5판에서 **상대가 두고 넘겨준** 국면 228개의
// 플레이어 관점 cp를 세면 중앙값이 **+233**이고 밴드 안이 **43.4%**다.
//
...
//
// **다만 그 5판을 둔 것이 에이전트다**(§39). 「밴드가 작동한다」까지가 이 숫자의 값이고,
// **「초심자에게 맞는 폭인가」는 아직 아무도 안 쟀다** — 밴드는 상대 실력에 맞추는
// 장치인데 맞춰 준 상대가 사람이 아니었다.
//
